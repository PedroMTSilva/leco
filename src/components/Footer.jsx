        ...
        <div className="container mx-auto lg:px-16 md:px-14 sm:px-12 px-10">
          <div className='lg:mx-12'>
            ...
            <p>
              ...
              <small className="text-muted text-warm-gray-600 dark:text-warm-gray-300 shadow-md shadow-blue-50 dark:shadow-warm-gray-800">{footerData.open_source_disclaimer}</small>
            </p>
          </div>
        </div>
      </div>
