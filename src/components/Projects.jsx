            ...
            return(
              <>
                <div className="bg-white hover:bg-gray-50 text-black rounded-md shadow-md p-4">
                  <div className="text-black text-xl text-left font-medium pl-4 pt-2">{repository.full_name}</div>
                  ...
                  <div className="grid grid-cols-2 gap-3 mt-4">
                    ...
                    <button className='border-2 border-blue-50 rounded-md bg-gray-800 text-white p-2'>
