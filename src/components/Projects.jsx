      ...
      <div className='w-full lg:px-32 md:px-16 px-8 mt-16'>
        ...
        {projectsArray.map((project, index) => (
          <div className="bg-white hover:bg-gray-50 text-black rounded-md shadow-md p-4">
            <div className="text-black text-xl text-left font-medium pl-4 pt-2">leandroc0rreia/leco</div>
            <div className="text-black text-lg text-left font-light pl-4 pt-6">It's a personal website/portfolio. Built in React and Tailwind.</div>
            <div className="pl-4 pt-6 mb-4 flex">
              <div className="text-black text-xs text-left font-bold">Linguagens: </div>
              <div className="text-left text-xs pl-1">Java</div>
            </div>
            <div className="flex">
              <div className="pl-4 mb-4 flex items-center">
                <div className="text-black text-xs text-left font-bold mr-1">Stars: </div>
                <div className="text-left text-xs bg-gray-900 text-white text-center p-0.5 rounded-lg">71</div>
              </div>
              <div className="pl-4 mb-4 flex items-center">
                <div className="text-black text-xs text-left font-light mr-1"><small>Updated 7ça</small></div>
              </div>
            </div>
            <hr className='pl-4'/>
            <div className="grid grid-cols-2 gap-3 mt-4">
              ...
              <button className='border-2 border-blue-50 rounded-md bg-gray-400 text-white p-2'>
                <a href={""} className='flex items-center justify-center'>
