      ...
      <div className='flex flex-col justify-center items-center w-full h-auto'>
        <div className='flex flex-col justify-center items-center'>
          ...
          <div className='basis-3/5'>
            <p className='dark:text-warm-gray-50 lg:text-8xl md:text-8xl sm:text-5xl text-3xl font-black text-center border-b-4 lg:border-b-8 md:border-b-8 border-yellow-400'>Projetos</p>
          </div>
          <div className='basis-1/5'></div>
        </div>
      </div>
              ...
              <>
                <div className="bg-white hover:bg-gray-50 text-black dark:bg-warm-gray-600 dark:hover:bg-warm-gray-500 dark:text-white rounded-md shadow-md p-4">
                  ...
                  <div className="pl-4 pt-6 mb-4 flex">
                    <div className="text-black dark:text-white text-xs text-left font-bold">Linguagens: </div>
                    {/* TODO: multiple languages */}
                    <div className="text-left text-xs pl-1">{repository.language}</div>
                  </div>
                  <div className="flex">
                    <div className="pl-4 mb-4 flex items-center">
                      <div className="text-black dark:text-white text-xs text-left font-bold mr-1">Stars: </div>
                    ...
                    <div className="pl-4 mb-4 flex items-center">
                      <div className="text-black dark:text-white text-xs text-left font-light mr-1"><small>Atualizado em {new Date(repository.pushed_at).toLocaleDateString()}</small></div>
                    </div>
                  </div>
                  <hr className='mb-4'/>
