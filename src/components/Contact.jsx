      ...
      <div className='flex flex-col justify-center items-center w-full h-auto'>
        <div className='flex flex-col justify-center items-center'>
          ...
          <div className='basis-3/5'>
            <p className='dark:text-warm-gray-50 lg:text-8xl md:text-8xl sm:text-5xl text-3xl font-black text-center border-b-4 lg:border-b-8 md:border-b-8 border-yellow-400'>Contacto</p>
          </div>
          <div className='basis-1/5'></div>
        </div>
        <div className='flex flex-col justify-center items-center mt-8'>
          <div className='basis-1/5'></div>
          <div className='basis-3/5'>
            <p className='dark:text-warm-gray-50 lg:text-xl md:text-xl sm:text-lg text-md font-medium text-center'>Se tiver alguma questão ou quiser falar comigo, esteja à vontade para contactar-me a qualquer altura.</p>
          </div>
          <div className='basis-1/5'></div>
        </div>
        {/* TODO: Send message */}
          ...
          <div className="bg-white text-black dark:bg-warm-gray-700 dark:text-white rounded-md shadow-md p-4 text-left">
            <form ref={form} onSubmit={sendEmail}>
              <div className="relative p-2">
                <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email:</label>
                ...
                <input type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-warm-gray-800 dark:border-warm-gray-600 dark:placeholder-warm-gray-300 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="exemplo@leandroc0rreia.com" name='email' id='email'/>
              </div>
              <div className="p-2">
                <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mensagem:</label>
                <textarea rows="6" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-warm-gray-800 dark:border-warm-gray-600 dark:placeholder-warm-gray-300 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Sua mensagem..." name='message' id='message'></textarea>
              </div>
