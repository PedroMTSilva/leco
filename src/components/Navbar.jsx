...
function Navbar() {
  ...
  return (
    <div className="fixed w-full h-16">
      <nav className="bg-white shadow-md shadow-blue-50">
        ...
        <Transition
          ...
          {<div className="md:hidden" id="mobile-menu">
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                <Link to="home" smooth={true} duration={500} className="text-blue-500 hover:bg-blue-50 text-black hover:text-blue-700 block px-3 py-2 rounded-md text-base font-medium">
                  Home
                </Link>
                <Link to="about" smooth={true} duration={500} className="text-blue-500 hover:bg-blue-50 text-black hover:text-blue-700 block px-3 py-2 rounded-md text-base font-medium">
                  Sobre
                </Link>
                <Link to="projects" smooth={true} duration={500} className="text-blue-500 hover:bg-blue-50 text-black hover:text-blue-700 block px-3 py-2 rounded-md text-base font-medium">
                  Projetos
                </Link>
                <Link to="contact" smooth={true} duration={500} className="text-blue-500 hover:bg-blue-50 text-black hover:text-blue-700 block px-3 py-2 rounded-md text-base font-medium">
                  Contacto
                </Link>
              </div>
            </div>}
